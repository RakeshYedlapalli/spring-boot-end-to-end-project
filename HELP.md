...
* The original package name 'com.endtoend.springboot.ui.spring-boot-end-to-end-app' is invalid and this project uses 'com.endtoend.springboot.ui.springbootendtoendapp' instead.
